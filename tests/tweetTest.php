...
class TweetTest extends \PHPUnit\Framework\TestCase {
	...
	public function testLinkedTweetWithUsername() {
		...
		$this->assertEquals('This is a tweet with a username <a href="https://x.com/awhalen">@awhalen</a> in it.', $t->get_linked_tweet());
	}
	...
	public function testLinkedTweetWithHashTag() {
		...
		$this->assertEquals('This is a tweet with a hashtag <a href="https://x.com/search?q=%23awesome">#awesome</a> in it.', $t->get_linked_tweet());
	}
	...
	public function testLinkedTweet() {
		...
		$this->assertEquals('<a href="https://x.com/awhalen">@awhalen</a> check out <a href="http://amwhalen.com">http://amwhalen.com</a> <a href="https://x.com/search?q=%23awesome">#awesome</a>', $t->get_linked_tweet());
	}
